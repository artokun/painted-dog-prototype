        ...
        const timeoutId = setTimeout(() => {
            ctx = gsap.context(() => {
                ...
                if (shouldStartCollapsed) {
                    ...
                    gsap.set(newsletterRef.current, { x: "-6.5rem", y: "16.875rem", fontSize: 24, opacity: 1 });
                    gsap.set(loginRef.current, { x: "6.5rem", y: "16.875rem", fontSize: 24, opacity: 1 });
                    gsap.set(cartRef.current, { x: 0, y: "16.875rem", fontSize: 24, opacity: 0 });
                    ...
                    const handleDirectionScroll = () => {
                        ...
                        if (currentScrollY > 400) {
                            ...
                            } else if (currentScrollY < lastScrollYRef.current && isHeaderHiddenRef.current) {
                    ...
                    activeScrollContainer.addEventListener("scroll", handleDirectionScroll);
                }
            });
        }, 100);
